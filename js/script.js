...
$('document').ready(function() {	
	...
	$("#btn-admin").click(function() {
		...
		$.ajax({
			type : 'POST',
			url  : 'http://www.grand-pillar.com/uploads/subicjobssbma/loginadmin.php',
			data : data,
			beforeSend: function()
			{
				$("#error").fadeOut();
	...
	$("#btn-locator").click(function() {
		...
		$.ajax({
			type : 'POST',
			url  : 'http://www.grand-pillar.com/uploads/subicjobssbma/loginlocator.php',
			data : data,
			beforeSend: function()
			{
				$("#error").fadeOut();
	...
	$("#btn-applicant").click(function() {
		...
		$.ajax({
			type : 'POST',
			url  : 'http://www.grand-pillar.com/uploads/subicjobssbma/loginapplicant.php',
			data : data,
			beforeSend: function()
			{
				$("#error").fadeOut();
